<aside
        ...
        <i class="fas fa-times p-3 cursor-pointer text-white opacity-5 position-absolute end-0 top-0 d-none d-xl-none"
            ...
            <a class="navbar-brand m-0 d-flex text-wrap align-items-center"
             ...
             >
                ...
                <span class="ms-2 font-weight-bold text-white">Petty Cash Management System</span>
            </a>
    </div>
    ...
    <div class="w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            {{-- <li class="nav-item">
                <a class="nav-link text-white {{ Route::currentRouteName() == 'currency-management' ? ' active bg-gradient-primary' : '' }} "
                    href="{{ route('currency-management') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Route::currentRouteName() == 'dashboard' ? ' active bg-gradient-primary' : '' }} "
                    ...
                    <span class="nav-link-text ms-1">Petty Cash</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white {{ Route::currentRouteName() == 'currency-management' ? ' active bg-gradient-primary' : '' }} "
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ Route::currentRouteName() == 'billing' ? ' active bg-gradient-primary' : '' }}  "
                    ...
                    <span class="nav-link-text ms-1">Payments & Receipts</span>
                </a>
            </li>
            <li class="nav-item">
            ...
            {{-- <li class="nav-item">
                <a class="nav-link text-white {{ Route::currentRouteName() == 'rtl' ? ' active bg-gradient-primary' : '' }}  "
                    ...
                    <span class="nav-link-text ms-1">Monthly Account O&P</span>
                </a>
            </li> --}}
        </ul>
    </div>
